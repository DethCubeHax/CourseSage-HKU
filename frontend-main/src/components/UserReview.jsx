  ...
  return (
    ...
    {/* UserReview */}
        <div className="icon">
            ...
            <p style={{paddingTop: "1px", fontWeight: "bold", fontSize: "14px", color: "#1e94d9"}}>0.69 out of 1.00</p>
        ...
        <div className='description'>
            ...
            <div style={{paddingLeft: "20px", paddingTop: "4px"}}>{review.substring(0,770)}. . . . . . </div>
        </div>
    </div>
